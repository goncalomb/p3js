var PIC = module.exports = function(cpu) {
	this._cpu = cpu;
	this.reset();
}
...
PIC.prototype.readFromAddress = function(addr, iak) {
	if (iak) {
		var int_number = null;
...
PIC.prototype.writeToAddress = function(addr, val) {
...
PIC.prototype.triggerInterrupt = function(i) {
